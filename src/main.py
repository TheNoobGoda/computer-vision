...
def main(video_path,save_imgs,see_video):
    ...
    keys= HandTrack.handTrakc(video_path,black_keys,white_keys,black_imgs, white_imgs,see_video)
    print(SheetMusic.getKeyNotes(black_keys,white_keys,keys))


if __name__ == "__main__":
    main('video/piano_video8.mp4',False,False)